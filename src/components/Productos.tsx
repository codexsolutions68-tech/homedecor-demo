...
const productos = [
  {
    ...
    img: "/images/stock-blackout.jpeg",
    ...
    <section id="productos" className="py-24 md:py-32 bg-paper-dim">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <Reveal className="max-w-2xl mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-ink leading-tight mb-5">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {productos.map((p, i) => (
            <Reveal key={p.nombre} delay={i * 100}>
              <article className="group bg-paper rounded-2xl overflow-hidden shadow-lg shadow-ink/5 h-full flex flex-col">
                ...
                <div className="p-7 flex flex-col flex-1">
                  ...
                  <a
                    ...
                    className="inline-flex w-fit items-center gap-2 text-ink font-bold text-sm border-b-2 border-orange pb-0.5 hover:text-orange transition-colors"
                  >
                    Cotiza este modelo →
                  </a>
                </div>
